...
public class GamePanel extends JPanel implements ActionListener {
    ...
    // Array that holds the body parts
    ...
    public void draw(Graphics g) {
        if(running) {
//            //Turn the screen into a grid to make it easier to see things
//            for (int i = 0; i < SCREEN_HEIGHT / UNIT_SIZE; i++) {
//                g.drawLine(i * UNIT_SIZE, 0, i * UNIT_SIZE, SCREEN_HEIGHT);
//                g.drawLine(0, i * UNIT_SIZE, SCREEN_WIDTH, i * UNIT_SIZE);
//            }

            //Randomly draw an apple
            ...
            // line the font in the middle of the screen
    ...
    public void move() {
        for(int i = bodyParts; i>0; i--) {
            x[i] = x[i-1]; //Shift all coordinates over by one spot
            y[i] = y[i-1];
        }
    ...
    // Control what happens while running
    @Override
